...
BLOG_AUTHOR = "Amikumu"  # (translatable)
...
BLOG_EMAIL = "help@amikumu.com"
BLOG_DESCRIPTION = "Find and connect instantly with local language partners nearby. We are the only app that supports 7,000+ languages including Catalan, Chinese, Dutch, Esperanto, Irish, Japanese, Occitan, Polish, Portuguese, Russian, Toki Pona and Welsh, all for FREE!"  # (translatable)
...
REDIRECTIONS = [("/en/privacy-policy/", "https://amikumu.com/privacy-terms/"),("/faq/", "https://amikumu.com/help-faq/"),("/get_gold", "https://app.amikumu.com/get_gold"),("/orighu", "https://app.amikumu.com/orighu"),("/shop/", "https://amikumu.redbubble.com/"),("/blackfriday", "https://app.amikumu.com/pages/blackfriday"),("/nigravendredo", "https://app.amikumu.com/pages/nigravendredo")]
